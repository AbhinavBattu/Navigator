...
export default function FlightSearchBar() {
  ...
  function checkWeatherConditions(weatherData, location) {
    ...
    if (!weatherData) {
      //toast.error(`Cannot fetch weather data for ${location}. Flight status is unknown.`);
      alert(
    ...
    if (weatherData.visibility && weatherData.visibility.km < minVisibility) {
      //toast.error(`Cannot fly because ${location} visibility is too low. Flight will be delayed.`);
      alert(
    ...
    if (weatherData.wind && weatherData.wind.speed > maxWindSpeed) {
      ...
      // toast.success(`Cannot fly because ${location} wind speed is too high. Flight will be delayed.`, {
      //   position: toast.POSITION.TOP_RIGHT,});
      alert(`Cannot fly because ${location} wind speed is too high. Flight will be delayed.`);
      conditionMet = false;
    }
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex">
        ...
        <div className="w-1/3 bg-gray-100 p-4 rounded shadow-sm">
            <FlightInfo
